        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input type="text" required placeholder="Enter destination account number" value={form.toAccount}
            ...
            <div>
              ...
              <input type="text" placeholder="e.g. Rent payment, School fees..." value={form.description}
            ...
            <button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 rounded-lg transition-colors text-sm">
              Initiate Transfer
            </button>
          </form>
        </div>
            ...
            {recentTransfers.map((t) => (
              <div key={t.id} className="flex items-center justify-between p-3.5 rounded-xl bg-slate-50 border border-slate-100">
                ...
                <div className="text-right">
                  ...
                  <span className={`text-xs font-medium px-2 py-0.5 rounded-full ${t.status === "Completed" ? "bg-green-100 text-green-700" : "bg-amber-100 text-amber-700"}`}>{t.status}</span>
                </div>
              </div>
            ))}
          </div>
